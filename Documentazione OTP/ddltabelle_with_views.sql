...
-- dbo.AMMINISTRATI source

CREATE VIEW AMMINISTRATI 
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_AMMINISTRATI ');


-- dbo.MIA_ADDEBITI_BONIFICHE source

CREATE VIEW MIA_ADDEBITI_BONIFICHE 
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_ADDEBITI_BONIFICHE ');


-- dbo.MIA_AMMINISTRATI_V source

CREATE VIEW MIA_AMMINISTRATI_V
   
   AS
      SELECT COD_AMM,COD_FIS_AMM  FROM OPENQUERY([GELCA64], 'SELECT COD_AMM,COD_FIS_AMM FROM MIA.MIA_AMMINISTRATI');


-- dbo.MIA_B_DET_LIQ source

CREATE VIEW MIA_B_DET_LIQ
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_B_DET_LIQ ');


-- dbo.MIA_COMUNE source

CREATE VIEW MIA_COMUNE
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_COMUNE');


-- dbo.MIA_COORDINATE_BANCARIE source

CREATE VIEW MIA_COORDINATE_BANCARIE
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_COORDINATE_BANCARIE');


-- dbo.MIA_DOCUMENTI_AMMI source

CREATE VIEW MIA_DOCUMENTI_AMMI
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_DOCUMENTI_AMMI');


-- dbo.MIA_PROGRESSIONI source

CREATE VIEW MIA_PROGRESSIONI
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_PROGRESSIONI');


-- dbo.MIA_RESIDENZE source

CREATE VIEW MIA_RESIDENZE
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_RESIDENZE');


-- dbo.MIA_SCHEDA_ANTROPOMETRICA source

CREATE VIEW MIA_SCHEDA_ANTROPOMETRICA
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_SCHEDA_ANTROPOMETRICA');


-- dbo.MIA_SCHEDA_SPETTANZE source

CREATE VIEW MIA_SCHEDA_SPETTANZE
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_SCHEDA_SPETTANZE');


-- dbo.MIA_TABELLE source

CREATE VIEW MIA_TABELLE
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_TABELLE');


-- dbo.MIA_TRASCINAMENTI source

CREATE VIEW MIA_TRASCINAMENTI
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MIA_TRASCINAMENTI');


-- dbo.MV_MIA_CFG source

CREATE VIEW MV_MIA_CFG
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MV_MIA_CFG');


-- dbo.MV_MIA_CFI source

CREATE VIEW MV_MIA_CFI
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MV_MIA_CFI');


-- dbo.MV_MIA_MISSIONI source

CREATE VIEW MV_MIA_MISSIONI
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MV_MIA_MISSIONI');


-- dbo.MV_MIA_PERSONALI source

CREATE VIEW MV_MIA_PERSONALI
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MV_MIA_PERSONALI');


-- dbo.MV_MIA_VARIE source

CREATE VIEW MV_MIA_VARIE
AS

SELECT * FROM OPENQUERY([GELCA64], 'SELECT * FROM MIA.MV_MIA_VARIE');
